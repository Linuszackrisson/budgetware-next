...
export default function Header() {
  return (
    <header className="border-b border-gray-800/50 bg-[#0A0A0A]/80 backdrop-blur-lg sticky top-0 z-50">
            ...
            <ul className="flex items-center gap-8">
              ...
              <li>
                <a 
                  ...
                  className="bg-emerald-500/10 text-emerald-400 px-4 py-2 rounded-md hover:bg-emerald-500/20 transition-all duration-200 inline-flex items-center gap-2 border border-emerald-500/20 hover:border-emerald-500/40"
                >
